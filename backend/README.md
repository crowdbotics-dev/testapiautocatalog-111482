...
## Project Structure
    ...
    ├── testapiautocatalog_111482  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_111482`
...
2. Clone this repo and `cd testapiautocatalog_111482`
